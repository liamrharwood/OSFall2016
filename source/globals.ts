...
//
const APP_NAME: string    = "HAXOS";   // 'cause Bob and I were at a loss for a better name.
const APP_VERSION: string = "1337";   // What did you expect?
...
var _MemorySize: number = 768; // 768 bytes, 3 segments of 256 bytes
var _SegmentSize: number = 256;
...
var _SystemStatus : string = "Operational";
